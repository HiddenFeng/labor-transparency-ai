...
15. Official registry/disclosure references, official company/brand/product/procurement relationships, and community claims are distinct data lanes. `OFFICIAL_SOURCE_REFERENCE` and `OFFICIAL_SOURCE_RELATION` require a specific approved official record and narrow scope; user-contributed brands/products/relationships remain contribution evidence with their own E-level/status. Do not promote a community claim to an official lane because it is popular or plausible, and do not promote a daily-delta reference to machine legal identity without the required stronger uniqueness/binding evidence.
